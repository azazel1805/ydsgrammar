...
const GI_SECTIONS = [
  {
    ...
    examples: [
      ...
      { en: 'He <span class="map-tag map-1">admitted</span> <span class="map-tag map-2">taking</span> the money.', tr: 'Parayı <span class="map-tag map-2">aldığını</span> <span class="map-tag map-1">kabul etti</span>.' },
      { en: 'Would you <span class="map-tag map-1">mind</span> <span class="map-tag map-2">opening</span> the window?', tr: 'Pencereyi <span class="map-tag map-2">açman</span><span class="map-tag map-1">ın sakıncası var mı</span>?' },
      { en: 'They <span class="map-tag map-1">keep</span> <span class="map-tag map-2">arguing</span> about money.', tr: 'Para konusunda <span class="map-tag map-2">tartışmaya</span> <span class="map-tag map-1">devam ediyorlar</span>.' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { en: 'He <span class="map-tag map-1">managed</span> <span class="map-tag map-2">to finish</span> on time.', tr: 'Zamanında <span class="map-tag map-2">bitirmeyi</span> <span class="map-tag map-1">başardı</span>.' },
      { en: 'They <span class="map-tag map-1">refused</span> <span class="map-tag map-2">to cooperate</span>.', tr: 'İşbirliği <span class="map-tag map-2">yapmayı</span> <span class="map-tag map-1">reddettiler</span>.' },
    ],
  ...
  },
  {
    ...
    examples: [],
    pairs: [
      { v: 'begin / start / continue', e1: 'It started <span class="map-tag map-1">raining</span>.', e2: 'It started <span class="map-tag map-1">to rain</span>.', t: 'Yağmur <span class="map-tag map-1">başladı</span>.' },
      { v: 'like / love / hate / prefer', e1: 'She likes <span class="map-tag map-1">swimming</span>.', e2: 'She likes <span class="map-tag map-1">to swim</span>.', t: '<span class="map-tag map-1">Yüzmeyi</span> seviyor.' },
      { v: 'intend / attempt / bother', e1: 'He attempted <span class="map-tag map-1">climbing</span> it.', e2: 'He attempted <span class="map-tag map-1">to climb</span> it.', t: '<span class="map-tag map-1">Tırmanmaya</span> çalıştı.' },
    ],
  ...
  },
  {
    ...
    verbs: [],
    examples: [
      { en: 'She is <span class="map-tag map-1">interested in</span> <span class="map-tag map-2">learning</span> French.', tr: 'Fransızca <span class="map-tag map-2">öğrenmeyle</span> <span class="map-tag map-1">ilgileniyor</span>.' },
      { en: 'He is <span class="map-tag map-1">good at</span> <span class="map-tag map-2">playing</span> chess.', tr: 'Satranç <span class="map-tag map-2">oynamakta</span> <span class="map-tag map-1">iyidir</span>.' },
      { en: '<span class="map-tag map-1">After</span> <span class="map-tag map-2">finishing</span> work, she went home.', tr: 'İşi <span class="map-tag map-2">bitirdik</span><span class="map-tag map-1">TEN SONRA</span> eve gitti.' },
      ...
      { en: 'I <span class="map-tag map-1">got used to</span> <span class="map-tag map-2">waking up</span> early.', tr: 'Erken <span class="map-tag map-2">kalkmaya</span> <span class="map-tag map-1">alıştım</span>.' },
    ],
  ...
  },
  {
    ...
    verbs: [],
    examples: [
      { en: '<span class="map-tag map-1">Swimming</span> is good exercise.', tr: '<span class="map-tag map-1">Yüzme</span> iyi bir egzersizdir.' },
      { en: 'It is <span class="map-tag map-1">important</span> <span class="map-tag map-2">to exercise</span> regularly.', tr: 'Düzenli <span class="map-tag map-2">egzersiz yapmak</span> <span class="map-tag map-1">önemlidir</span>.' },
      { en: 'It was <span class="map-tag map-1">kind OF you</span> <span class="map-tag map-2">to help</span>.', tr: '<span class="map-tag map-2">Yardım etmen</span> <span class="map-tag map-1">nezaketindi</span> (senin nazikliğin).' },
      { en: 'It is <span class="map-tag map-1">easy FOR us</span> <span class="map-tag map-2">to understand</span>.', tr: '<span class="map-tag map-2">Anlamamız</span> bizim için <span class="map-tag map-1">kolaydır</span>.' },
    ],
