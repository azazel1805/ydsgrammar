...
<div class="bg-gradient-to-br from-red-600 via-orange-600 to-pink-600 text-black p-6 rounded-2xl shadow-xl">
...
<div class="text-right">
 ...
 class="px-5 py-2 bg-emerald-600 text-black rounded-lg font-bold shadow hover:scale-105 transition">
...
<div id="prepQuizModal" class="fixed inset-0 bg-black/80 hidden items-center justify-center z-[200]">
 <div class="bg-white p-8 rounded-xl w-full max-w-xl shadow-2xl relative">
