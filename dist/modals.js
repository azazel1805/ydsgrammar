...
<div class="bg-gradient-to-br from-blue-600 via-cyan-600 to-indigo-600 text-black p-6 rounded-2xl shadow-xl">
...
<section class="modal-section searchable-section">
 ...
 <div class="w-10 h-10 rounded bg-violet-100 text-violet-600 flex items-center justify-center text-xl font-bold">
...
<!-- 1. ABILITY & POSSIBILITY -->
 ...
 <div class="section-header">
 <div class="w-10 h-10 rounded bg-emerald-100 text-red-800 flex items-center justify-center text-xl font-bold"><i class="fa-solid fa-dumbbell"></i></div>
 <h2 class="text-2xl font-bold text-slate-800 ">Ability & Possibility</h2>
 </div>
 ...
 <td class="p-4">
 <div class="font-bold text-lg text-emerald-700 ">Can</div>
 ...
 <tr class="hover:bg-slate-50 align-top">
 <td class="p-4">
 <div class="font-bold text-lg text-emerald-700 ">Could</div>
 ...
 <tr class="hover:bg-slate-50 align-top">
 <td class="p-4">
 <div class="font-bold text-lg text-emerald-700 ">Be able to</div>
 ...
 <tr class="hover:bg-slate-50 align-top">
 <td class="p-4">
 <div class="font-bold text-lg text-purple-700 ">May / Might</div>
 ...
 <div class="text-[10px] text-gray-500">%50 Probability</div>
 </td>
 <td class="p-4">
 <ul class="usage-list">
...
<section class="modal-section searchable-section" data-cat="Obligation">
 <div class="section-header">
 <div class="w-10 h-10 rounded bg-red-100 text-red-600 flex items-center justify-center text-xl font-bold"><i class="fa-solid fa-triangle-exclamation"></i></div>
 <h2 class="text-2xl font-bold text-slate-800 ">Obligation & Advice</h2>
 </div>

 <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
 <!-- TRAP ALERT BOX -->
 <div class="col-span-1 md:col-span-2 bg-rose-50 border border-rose-200 rounded-lg p-4 flex gap-4 items-center">
 <i class="fa-solid fa-skull-crossbones text-2xl text-rose-500"></i>
 <div>
 <h3 class="font-bold text-rose-700 text-sm uppercase">Biggest Trap: Negative Forms</h3>
 ...
 <tr class="hover:bg-slate-50 align-top">
 <td class="p-4">
 <div class="font-bold text-lg text-red-700 ">Must</div>
 </td>
 <td class="p-4">
 <ul class="usage-list">
 ...
 <tr class="hover:bg-slate-50 align-top">
 <td class="p-4">
 <div class="font-bold text-lg text-red-700 ">Have to</div>
 ...
 <tr class="hover:bg-slate-50 align-top">
 <td class="p-4">
 <div class="font-bold text-lg text-black ">Should / Ought to</div>
...
<section class="modal-section searchable-section" data-cat="Deduction">
 <div class="section-header">
 <div class="w-10 h-10 rounded bg-indigo-100 text-indigo-600 flex items-center justify-center text-xl font-bold"><i class="fa-solid fa-magnifying-glass"></i></div>
 <h2 class="text-2xl font-bold text-slate-800 ">Deduction (Present)</h2>
 </div>
 <p class="mb-4 text-sm text-slate-600 ">Dedektif gibi eldeki ipuçlarına bakarak <u>şu an</u> hakkında çıkarım yapma.</p>
 
 <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
 <!-- Strong Positive -->
 <div class="p-4 bg-white border-l-4 border-green-500 shadow rounded-r-lg">
 <div class="font-bold text-lg text-slate-800 ">Must be</div>
 ...
 <!-- Possibility -->
 <div class="p-4 bg-white border-l-4 border-yellow-500 shadow rounded-r-lg">
 <div class="font-bold text-lg text-slate-800 ">May/Might/Could be</div>
 ...
 <!-- Strong Negative -->
 <div class="p-4 bg-white border-l-4 border-red-500 shadow rounded-r-lg">
 <div class="font-bold text-lg text-slate-800 ">Can't be</div>
...
<section class="modal-section searchable-section" data-cat="Perfect">
 <div class="section-header">
 <div class="w-10 h-10 rounded bg-amber-100 text-amber-600 flex items-center justify-center text-xl font-bold"><i class="fa-solid fa-hourglass-half"></i></div>
 <h2 class="text-2xl font-bold text-slate-800 ">Perfect Modals (Past)</h2>
 </div>
 <p class="mb-4 text-sm font-semibold text-amber-600 border border-amber-200 bg-amber-50 p-2 rounded">
...
<div class="example-text">
 ...
 <!-- SHOULD HAVE V3 -->
 <tr class="hover:bg-amber-50/50 bg-rose-50/30">
 <td class="p-4 border-l-4 border-blue-500">
 <div class="font-bold text-lg text-rose-700 ">Should / Ought to have V3</div>
 ...
 <div class="section-header">
 <div class="w-10 h-10 rounded bg-pink-100 text-pink-600 flex items-center justify-center text-xl font-bold"><i class="fa-solid fa-heart"></i></div>
 <h2 class="text-2xl font-bold text-slate-800 ">Preference & Habits</h2>
 </div>
...
<!-- 6. SEMI-MODALS & FORMAL STRUCTURES (CRITICAL FOR YDS) -->
 <section class="modal-section searchable-section" data-cat="Obligation">
 <div class="section-header">
 <div class="w-10 h-10 rounded bg-cyan-100 text-cyan-600 flex items-center justify-center text-xl font-bold"><i class="fa-solid fa-user-tie"></i></div>
 <h2 class="text-2xl font-bold text-slate-800 ">Formal & Semi-Modals</h2>
 </div>
...
<div class="example-text">
 ...
 <section class="modal-section searchable-section" data-cat="Preference">
 <div class="section-header">
 <div class="w-10 h-10 rounded bg-fuchsia-100 text-fuchsia-600 flex items-center justify-center text-xl font-bold"><i class="fa-solid fa-scale-unbalanced"></i></div>
 <h2 class="text-2xl font-bold text-slate-800 ">Preference Matrix</h2>
 </div>

 <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
 <!-- General Preference -->
 <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
 <h3 class="font-bold text-lg text-black mb-3">General Preference (Genel Tercih)</h3>
 <div class="space-y-4">
 <div>
 ...
 <!-- Specific Preference -->
 <div class="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
 <h3 class="font-bold text-lg text-fuchsia-600 mb-3">Specific Choice (Şu anki Seçim)</h3>
 <div class="space-y-4">
 <div>
