...
<div class="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm mb-6">
    <div class="relative w-full">
        ...
        <input type="text" onkeyup="filterTab(this)" placeholder="Relative ara: reduction, preposition, whom, whose..." 
            class="block w-full pl-11 pr-4 py-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all font-medium">
    </div>
</div>

<!-- 1. Pronoun Matrix -->
<section class="relative-section bg-white dark:bg-slate-900 rounded-lg shadow border border-slate-200 dark:border-slate-800 overflow-hidden mb-6">
    <div class="p-4 bg-indigo-50 dark:bg-indigo-900/20 border-b border-indigo-100 dark:border-indigo-900/30 flex items-center gap-3">
        ...
        <h2 class="text-xl font-bold text-indigo-800 dark:text-indigo-400">Relative Pronouns & Rules</h2>
    </div>

<div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-4 rounded-lg mb-6">
    <h3 class="font-bold text-green-700 dark:text-green-400 mb-2">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <section class="bg-white dark:bg-slate-900 rounded-lg shadow border border-slate-200 dark:border-slate-800 p-5">
        <h3 class="font-bold text-lg mb-3 flex items-center gap-2 text-indigo-700 dark:text-indigo-400">
        ...
        <div class="space-y-4">
            <div class="flex gap-3 items-start p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                <span class="badge-str shrink-0">Ving</span>
                <div class="text-sm">
                    <strong class="block text-slate-800 dark:text-white">Active Reduction</strong>
            ...
            <div class="flex gap-3 items-start p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                ...
                <div class="text-sm">
                    <strong class="block text-slate-800 dark:text-white">Passive Reduction</strong>
            ...
            <div class="flex gap-3 items-start p-3 bg-slate-50 dark:bg-slate-800 rounded-lg border-l-4 border-indigo-400">
                <span class="badge-str shrink-0">To V1</span>
                <div class="text-sm">
                    <strong class="block text-slate-800 dark:text-white">Ordinal Numbers / Superlatives</strong>
    ...
    <div class="space-y-6">
        ...
        <section class="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-100 dark:border-indigo-800 p-5">
            <h3 class="font-bold text-lg mb-2 text-indigo-800 dark:text-indigo-300">Preposition + Relative</h3>
            <ul class="text-sm space-y-2 list-disc pl-4 text-slate-700 dark:text-slate-300">
        ...
        <section class="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-5">
            ...
            <div class="text-xs text-slate-400 mt-1">(Ailesini mutlu eden şey sınavı geçmesi durumudur, sınavın kendisi değil.)</div>
        </section>
    </div>
</div>
`;
