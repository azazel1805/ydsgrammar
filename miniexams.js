...
bg-slate-100 dark:bg-slate-800
text-slate-900 dark:text-slate-100
hover:bg-cyan-100 dark:hover:bg-cyan-700
border border-slate-300 dark:border-slate-600
`;
...
function showMiniResult() {
    ...
    miniExamResults.forEach((r, index) => {
     ...
     border border-slate-200 dark:border-slate-700">
                ...
                <div class="${r.isCorrect ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}">
...
` : ''}
    ...
    <button onclick="startMiniExam()" 
            class="px-5 py-2 bg-cyan-600 rounded hover:bg-cyan-700">
        🔁 Try Again
    </button>

    <button onclick="resetMiniExam()" 
            class="px-5 py-2 bg-slate-700 rounded hover:bg-slate-600">
