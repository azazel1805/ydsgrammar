...
function analyzeText(text) {
 ...
 // CONJUNCTIONS HIGHLIGHTER (NEW)
 const targetConjunctions = [
 "however", "therefore", "although", "even though", "moreover",
 "furthermore", "in contrast", "on the other hand", "thus", "hence",
 "nevertheless", "nonetheless", "despite", "in spite of", "whereas", "while"
 ];
