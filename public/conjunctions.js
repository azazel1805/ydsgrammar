...
<section class="conj-section searchable-section" data-cat="Time">
 ...
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-cyan-600 ">The moment / The instant</td><td class="p-3 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 ">...dığı anda</td><td class="p-3 group cursor-pointer" onclick="speak(this)">The moment I saw it, I knew. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-cyan-600 ">Whenever</td><td class="p-3 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 ">Her ne zaman</td><td class="p-3 group cursor-pointer" onclick="speak(this)">Whenever I go there, it rains. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-cyan-600 ">No sooner ... than</td><td class="p-3 sm:table-cell"><span class="badge badge-sv">Inversion</span></td><td class="p-3 text-slate-600 ">...mesiyle ...mesi bir oldu</td><td class="p-3 group cursor-pointer" onclick="speak(this)">No sooner had I sat down than the bell rang. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-cyan-600 ">Hardly ... when</td><td class="p-3 sm:table-cell"><span class="badge badge-sv">Inversion</span></td><td class="p-3 text-slate-600 ">Tam ...yordu ki</td><td class="p-3 group cursor-pointer" onclick="speak(this)">Hardly had we started when the power went out. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <!-- Prepositional Time -->
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-gray-500 ">During</td><td class="p-3 sm:table-cell"><span class="badge badge-noun">+Noun</span></td><td class="p-3 text-slate-600 ">Sırasında / Boyunca</td><td class="p-3 group cursor-pointer" onclick="speak(this)">He slept during the lesson. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-gray-500 ">Prior to</td><td class="p-3 sm:table-cell"><span class="badge badge-noun">+Noun</span></td><td class="p-3 text-slate-600 ">-den önce</td><td class="p-3 group cursor-pointer" onclick="speak(this)">Prior to the meeting, we had coffee. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 </tbody>
 </table>
 </div>
</section>
...
<section class="conj-section searchable-section" data-cat="Contrast">
 ...
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-rose-600 ">However</td><td class="p-3 sm:table-cell"><span class="badge badge-adv">Adv</span></td><td class="p-3 text-slate-600 ">Ancak, ama</td><td class="p-3 group cursor-pointer" onclick="speak(this)">It is hard; however, it is possible. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-rose-600 ">Nevertheless / Nonetheless</td><td class="p-3 sm:table-cell"><span class="badge badge-adv">Adv</span></td><td class="p-3 text-slate-600 ">Yine de, buna rağmen</td><td class="p-3 group cursor-pointer" onclick="speak(this)">He made mistakes; nevertheless, he won. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-rose-600 ">On the other hand</td><td class="p-3 sm:table-cell"><span class="badge badge-adv">Adv</span></td><td class="p-3 text-slate-600 ">Öte yandan</td><td class="p-3 group cursor-pointer" onclick="speak(this)">City life is fast; on the other hand, it's noisy. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-rose-600 ">Conversely</td><td class="p-3 sm:table-cell"><span class="badge badge-adv">Adv</span></td><td class="p-3 text-slate-600 ">Aksine</td><td class="p-3 group cursor-pointer" onclick="speak(this)">The North is rich; conversely, the South is poor. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 </tbody>
 </table>
 </div>
</section>
