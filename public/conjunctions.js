...
<section class="conj-section searchable-section" data-cat="Time">
 ...
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-cyan-600 w-1/4">When</td><td class="p-3 w-20 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 w-1/4">-dığı zaman</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">When I saw him, I smiled. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-cyan-600 ">While / As</td><td class="p-3 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 ">-iken (süreç)</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">While I was sleeping, the phone rang. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
...
<section class="conj-section searchable-section" data-cat="Contrast">
 ...
 <table class="w-full text-left border-collapse">
 <tbody class="divide-y divide-slate-100 text-sm">
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-rose-600 w-1/4">Although / Though</td><td class="p-3 w-20 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 w-1/4">-e rağmen</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">Although he is old, he runs fast. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 ...
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-rose-600 ">Despite / In spite of</td><td class="p-3 sm:table-cell"><span class="badge badge-noun">+Noun</span></td><td class="p-3 text-slate-600 ">-e rağmen</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">Despite the rain, we went out. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
...
<section class="conj-section searchable-section" data-cat="Cause">
 ...
 <table class="w-full text-left border-collapse">
 <tbody class="divide-y divide-slate-100 text-sm">
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-amber-600 w-1/4">Because / As / Since</td><td class="p-3 w-20 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 w-1/4">Çünkü, -dığı için</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">I left because I was bored. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 ...
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-amber-600 ">Because of / Due to / Owing to</td><td class="p-3 sm:table-cell"><span class="badge badge-noun">+Noun</span></td><td class="p-3 text-slate-600 ">...nedeniyle</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">Due to the storm, flights were cancelled. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 ...
 <table class="w-full text-left border-collapse">
 <tbody class="divide-y divide-slate-100 text-sm">
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-violet-600 w-1/4">If</td><td class="p-3 w-20 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 w-1/4">Eğer</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">If you study, you pass. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-violet-600 ">Unless</td><td class="p-3 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 ">-medikçe (if not)</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">Unless you run, you will be late. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
 ...
 <table class="w-full text-left border-collapse">
 <tbody class="divide-y divide-slate-100 text-sm">
 <tr class="hover:bg-slate-50 "><td class="p-3 font-bold text-pink-600 w-1/4">So that / In order that</td><td class="p-3 w-20 sm:table-cell"><span class="badge badge-sv">S+V</span></td><td class="p-3 text-slate-600 w-1/4">-sın diye</td><td class="p-3 hidden md:table-cell group cursor-pointer" onclick="speak(this)">I work hard so that I can retire early. <i class="fa-solid fa-copy copy-icon ml-2 text-gray-500 hover:text-blue-500" onclick="copyText(event, this)"></i></td></tr>
